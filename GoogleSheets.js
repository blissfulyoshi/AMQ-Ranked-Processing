...
function test() {
  ...
  console.log(result)
  //should get the output https://gist.github.com/ae82105ae7525f4bc364dff10f25e1a6
}
...
function getDateRow(selectedSheet, processedDate) {
  ...
  for (var i = 0; i < dateCells.length; i++) {
    ...
    if (processedDate.getDate() === dateCells[i][0].getDate() && processedDate.getMonth() === dateCells[i][0].getMonth()) {
      return 3+i
    }
  }
